          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center gap-2">
              <div className="flex items-center gap-1">
                <span className="text-2xl sm:text-2xl md:text-3xl font-extrabold bg-gradient-to-r from-gray-900 via-blue-600 to-blue-400 bg-clip-text text-transparent">
                  Car Readers
                </span>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-[100] bg-white p-4 sm:p-6">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-1">
              <span className="text-2xl font-extrabold bg-gradient-to-r from-gray-900 via-blue-600 to-blue-400 bg-clip-text text-transparent">
                Car Readers
              </span>
