...
export const metadata: Metadata = {
  ...
  description: 'Read our privacy policy to understand how Car Readers collects, uses, and protects your personal information.',
  openGraph: {
    title: 'Privacy Policy - Car Readers',
