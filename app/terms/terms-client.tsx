      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="mt-10 space-y-8 max-w-3xl mx-auto text-gray-700">
          <section>
            ...
            <p className="mt-3">Welcome to Car Readers, operated by Nexlify Labs LTD. By accessing and using our website and services, you agree to comply with and be bound by the following terms and conditions. If you do not agree with any part of these terms, please do not use our services.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">All content on Car Readers, including but not limited to text, graphics, logos, images, and software, is the property of Nexlify Labs LTD or its licensors and is protected by copyright, trademark, and other intellectual property laws.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">Nexlify Labs LTD and Car Readers shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use or inability to use our services. Our total liability shall not exceed the amount paid by you for the specific service in question.</p>
          </section>
          ...
          <section className="bg-gray-50 p-6 rounded-lg border border-gray-200 mt-8">
            <p className="text-sm text-gray-700">By accessing and using Car Readers, you acknowledge that you have read, understood, and agreed to these Terms and Conditions.</p>
          </section>
        </div>
      </div>
    </div>
