      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="mt-10 space-y-8 max-w-3xl mx-auto text-gray-700">
          ...
          <section>
            ...
            <p className="mt-3">These Terms and Conditions ("Agreement") form a legally binding contract between you ("Buyer", "you", or "your"), <strong>Merchant</strong> (as defined below), and <strong>Nexlify Labs LTD</strong> ("Supplier", "we", "our", or "us") and govern your use of the services provided via <strong>Car Readers</strong>.</p>
          ...
          <section>
            ...
            <ul className="mt-3 space-y-3">
              ...
              <li><strong>Product:</strong> Digital Digital pdf reports and related services provided by Nexlify Labs LTD</li>
          ...
          <section>
            ...
            <ol className="mt-3 space-y-2 list-decimal list-inside">
              <li>You select a Product on Car Readers</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900">Intellectual Property</h2>
              <p className="mt-3">All content, reports, branding, and systems on Car Readers are the intellectual property of <strong>Nexlify Labs LTD</strong> and may not be copied, resold, or redistributed.</p>
          </section>
