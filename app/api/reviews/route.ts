      ...
      const userConfirmationEmail = `
        <div style="font-family: sans-serif; max-width: 600px; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
          ...
          <div style="background: #f0f9ff; padding: 15px; border-radius: 8px; border-left: 4px solid #3b82f6; margin: 20px 0;">
            <h3 style="margin-top: 0; color: #1e40af;">Your Review:</h3>
          ...
          <p>Best Regards,<br/><strong>Car Readers Team</strong></p>
        </div>
      `
    ...
    try {
      const adminNotificationEmail = `
        <div style="font-family: sans-serif; max-width: 600px; padding: 20px; border: 1px solid #2563eb; border-radius: 10px; background: #eff6ff;">
          <h2 style="color: #2563eb;">⭐ New Review Submission</h2>
          ...
          <div style="background: white; padding: 15px; border-radius: 8px; border: 1px solid #bfdbfe; margin: 20px 0;">
            <h3 style="margin-top: 0; color: #1e40af; border-bottom: 2px solid #2563eb; padding-bottom: 10px;">Review Details:</h3>
      ...
      const adminEmail = process.env.ADMIN_PAYMENT_EMAIL || 'carreaders@gmail.com'
      await sendEmail(
        adminEmail,
