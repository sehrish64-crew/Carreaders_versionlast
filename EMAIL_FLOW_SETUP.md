...
### 1️⃣ **Step 1: User Fills Get Report Form**
   ...
   - **What Happens:** 
     ...
     - ✉️ **Email sent to:** `carreaders@gmail.com`
...
#### 📧 **Email #1 - Customer Order Confirmation**
   - **Sent to:** `carreaders@gmail.com` (customer's email)
   - **From:** `carreaders@gmail.com`
   - **Content:**
     - Order ID
     - Amount paid
     - Package details
...
#### 📧 **Email #2 - Admin Payment Notification**
   - **Sent to:** `carreaders@gmail.com` (admin)
   - **From:** `carreaders@gmail.com`
   - **Content:**
     - Customer email
     - Order details
...
| **SMTP Port** | `587` |
| **SMTP User** | `carreaders@gmail.com` |
| **Email From** | `Car Readers <carreaders@gmail.com>` |
| **Admin Email** | `carreaders@gmail.com` |
...
5. ✅ Check if you received the form submission email at `carreaders@gmail.com`
...
```
To: user@example.com
Subject: Payment Confirmed - Car Readers Order #ORD-123456
